define({ "api": [
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>The suggestion ID</p> "
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "name",
            "description": "<p>The name of the suggestion</p> "
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "location",
            "description": "<p>The location of the suggestion</p> "
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "votes",
            "description": "<p>The current votes of the suggestion</p> "
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "gameId",
            "description": "<p>The game the suggestion is attached to</p> "
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "UserId",
            "description": "<p>The user that suggested the game</p> "
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/suggestion_data/yelp_suggestions/:id",
    "title": "Get Suggestions from Yelp Api",
  ...
  {
    "type": "get",
    "url": "/suggestion_data/yelp_suggestions_initial?center=:center&event_type=:event_type&radius=:radius",
    "title": "Get Suggestions from Yelp Api (for initial suggestion)",
    "description": "<p>Gets Suggestions from the Yelp API using URL parameters</p> ",
    "name": "GetYelpSuggestionsInitial",
    "group": "Suggestion",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "center",
            "description": "<p>Center location</p> "
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/user_data/get_game_users/:game_id",
    "title": "Get Users in a Game",
    "name": "GetGameUsers",
    "group": "User",
    "parameter": {
      "fields": {
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "users",
            "description": "<p>List of Users in the Game</p> "
          }
        ]
      }
    },
